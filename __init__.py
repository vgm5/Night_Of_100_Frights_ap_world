    ...
    def get_items(self):
       ...
       #     itempool += [ItemNames.SnackBox] * also alot
        ...
        if self.options.include_keys.value:
            ...
            itempool += [ItemNames.Cellar2_Key, ItemNames.Graveplot_Key, ItemNames.Attic_Key, ItemNames.Creepy3_Key, ItemNames.DLD_Key, ItemNames.Shiver_Key] * 3  # Triple Keys
            itempool += [ItemNames.Cellar3_Key, ItemNames.Cavein_Key, ItemNames.FishyClues_Key, ItemNames.MYM_Key, ItemNames.Coast_Key, ItemNames.Knight_Key, ItemNames.Gusts2_Key] * 4  # Quad Keys
